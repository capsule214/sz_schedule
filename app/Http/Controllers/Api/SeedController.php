  ...
  private function seedMorders(int $baseTimestamp, int $count = 100): array
  {
    ...
    for ($i = 1; $i <= $count; $i++) {
      $morder = KdMorder::create([
        ...
        'koutei_pic_no' => str_pad((string) $i, 5, '0', STR_PAD_LEFT),
  ...
  public function seed(Request $request)
  {
    ...
    for ($i = 1; $i <= 100; $i++) {
      ...
      $s = KdSerial::create([
        ...
        'flg_syoyo' => $i % 3 === 0 ? 1 : 0,
        'koujun_id' => $i,
        'morder_start_date' => date('Y-m-d', $base + $this->lcgRange(0, 180) * 86400),
        'koutei_pic_no' => str_pad((string) $i, 5, '0', STR_PAD_LEFT),
  ...
  public function seedMaster(Request $request)
  {
    ...
    for ($i = 1; $i <= 100; $i++) {
      ...
      $serial = KdSerial::create([
        ...
        'flg_syoyo' => $i % 3 === 0 ? 1 : 0,
        'koujun_id' => $i,
        'morder_start_date' => date('Y-m-d', strtotime($shippingDate) - $this->lcgRange(10, 90) * 86400),
        'koutei_pic_no' => str_pad((string) $i, 5, '0', STR_PAD_LEFT),
